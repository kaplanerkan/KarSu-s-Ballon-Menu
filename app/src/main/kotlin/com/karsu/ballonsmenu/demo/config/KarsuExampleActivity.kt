...
import com.karsu.ballonsmenu.app.databinding.ActivityKarsuExampleBinding
...
class KarSuExampleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityKarsuExampleBinding.inflate(layoutInflater)
        ...
        binding.listView.apply {
            ...
            setOnItemClickListener { _, _, position, _ ->
                bmb.karsuEnum = KarSuEnum.values()[position]
            }
        }
    }
