...
import com.karsu.ballonsmenu.app.databinding.ActivityCustomPositionBinding

class CustomPositionActivity : AppCompatActivity() {

    private lateinit var binding: ActivityCustomPositionBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCustomPositionBinding.inflate(layoutInflater)
