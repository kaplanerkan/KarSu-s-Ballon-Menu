...
object AnimationManager {
    ...
    fun calculateShowXY(
        ...
        var effectiveBoomEnum = boomEnum
        if (abs(startPosition.x - endPosition.x) < 1) effectiveBoomEnum = BoomEnum.LINE
    ...
    fun calculateHideXY(
        ...
        when (effectiveBoomEnum) {
            ...
            BoomEnum.RANDOM,
            BoomEnum.Unknown -> {
                calculateShowXY(effectiveBoomEnum, parentSize, ease, frames, startPosition, endPosition, xs, ys)
            }
            BoomEnum.HORIZONTAL_THROW_1 -> {
                x2 = startPosition.x
                y2 = startPosition.y
