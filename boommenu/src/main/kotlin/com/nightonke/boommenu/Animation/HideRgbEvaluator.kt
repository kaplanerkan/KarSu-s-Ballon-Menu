...
class HideRgbEvaluator private constructor() : TypeEvaluator<Int> {
    ...
    private fun speedMap(fraction: Float): Float {
        if (fraction <= 0.5f) return 0f
        var trueSpeed = (fraction - 0.5f) * 2
    ...
    companion object {
        @JvmStatic
        val instance: HideRgbEvaluator = HideRgbEvaluator()
    }
}
