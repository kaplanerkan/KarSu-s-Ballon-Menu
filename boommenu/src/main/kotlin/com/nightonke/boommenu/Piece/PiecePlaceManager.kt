...
object PiecePlaceManager {
    ...
    fun createPiece(bmb: BoomMenuButton, builder: BoomButtonBuilder<*>): BoomPiece {
        return when (bmb.buttonEnum) {
            com.nightonke.boommenu.ButtonEnum.SimpleCircle,
            com.nightonke.boommenu.ButtonEnum.TextInsideCircle,
            com.nightonke.boommenu.ButtonEnum.TextOutsideCircle -> {
                createDot(bmb.context, builder, bmb.pieceCornerRadius)
            }
            com.nightonke.boommenu.ButtonEnum.Ham -> {
