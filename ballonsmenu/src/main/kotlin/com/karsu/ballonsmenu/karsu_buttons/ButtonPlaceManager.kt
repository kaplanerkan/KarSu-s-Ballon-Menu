...
object ButtonPlaceManager {
    ...
    private fun adjust(
        ...
        android.util.Log.d("KarSuMenu", "adjust: alignment=${bmb.buttonPlaceAlignmentEnum}, parentSize=$parentSize, halfW=$halfWidth, halfH=$halfHeight, minX=$minX, maxX=$maxX, minY=$minY, maxY=$maxY, xOffset=$xOffset, yOffset=$yOffset")
        adjust(ps, xOffset, yOffset)
    }

    private fun adjust(ps: ArrayList<PointF>, offsetX: Float, offsetY: Float) {
        android.util.Log.d("KarSuMenu", "adjust(offset): offsetX=$offsetX, offsetY=$offsetY")
